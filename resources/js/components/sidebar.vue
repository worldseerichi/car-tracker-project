      ...
      <nav class="sidebar-navigation">
        ...
        <router-link to="/" class="sidebar-navlink">
          <div class="sidebar-container1">
            ...
            <h1 class="sidebar-heading">{{ heading1 }}</h1>
          </div>
        </router-link>
        <router-link to="/g-p-s" class="sidebar-navlink1">
          <div class="sidebar-container2">
            ...
            <h1 class="sidebar-heading1">{{ heading11 }}</h1>
          </div>
        </router-link>
        <div class="sidebar-container3">
          ...
          <h1 class="sidebar-heading2">{{ heading111 }}</h1>
        </div>
      </nav>
      <nav class="sidebar-minimize">
