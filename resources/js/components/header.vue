  ...
  <div data-role="Header" class="header-header" v-bind:class="rootClassName">
    ...
    <div class="header-container">
      ...
      <div class="header-container2">
        ...
        <span class="header-text1 textSM"><span>Logs</span></span>
      </div>
    </div>
    <div data-type="MobileMenu" class="header-mobile-menu">
      ...
      <div class="header-mid">
        ...
        <div class="header-container4">
          ...
          <span class="header-text4 textSM">BLOG</span>
        </div>
      </div>
      <div class="header-bot">
        <svg viewBox="0 0 877.7142857142857 1024" class="header-icon18">
          <path
            d="M713.143 73.143c90.857 0 164.571 73.714 164.571 164.571v548.571c0 90.857-73.714 164.571-164.571 164.571h-107.429v-340h113.714l17.143-132.571h-130.857v-84.571c0-38.286 10.286-64 65.714-64l69.714-0.571v-118.286c-12-1.714-53.714-5.143-101.714-5.143-101.143 0-170.857 61.714-170.857 174.857v97.714h-114.286v132.571h114.286v340h-304c-90.857 0-164.571-73.714-164.571-164.571v-548.571c0-90.857 73.714-164.571 164.571-164.571h548.571z"
          ></path></svg
        ><svg viewBox="0 0 1024 1024" class="header-icon20">
          <path
          ...
          ></path></svg
        ><svg viewBox="0 0 877.7142857142857 1024" class="header-icon22">
          <path
