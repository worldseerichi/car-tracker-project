<template>
  <div data-role="Header" class="header-header" v-bind:class="rootClassName">
    ...
    <div class="header-container">
      ...
      <router-link to="/g-p-s" class="header-navlink1">
      ...
      <router-link to="/register-accounts" class="header-navlink2">
        <div class="header-container2">
          <svg viewBox="0 0 1170.2857142857142 1024" class="header-icon04">
            <path
          ...
          <span class="header-text1 textSM"><span>Register Accounts</span></span>
        </div>
      </router-link>
    </div>
    <router-link to="/login" class="header-navlink3">
      <div class="header-container3">
        ...
        <span class="header-text3 textSM"><span>Login</span></span>
      </div>
    </router-link>
    <div data-type="MobileMenu" class="header-mobile-menu">
      <div class="header-top">
        <router-link to="/" class="header-navlink4">
      ...
      <div class="header-mid">
        <router-link to="/g-p-s" class="header-navlink5">
          <div class="header-container4">
            ...
            <span class="header-text5 textSM">PROFILE</span>
          </div>
        </router-link>
        <div class="header-container5">
          ...
          <span class="header-text6 textSM">BLOG</span>
        </div>
      </div>
